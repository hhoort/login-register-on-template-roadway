<?php 
 ...
 if(isset($_POST['login'])){
   ...
   $verify = "select * from `user-data` where email = '$login_email'";
 $connect_login = mysqli_query($connection,$verify);
if(mysqli_num_rows($connect_login)>0){
   $rows = mysqli_fetch_assoc($connect_login);
   $db_pass = $rows['password'];
   $pass_decode = password_verify($login_pass,$db_pass);
   if($pass_decode){
      header('location:http://localhost:82/techtemp/techtemp/index.php');
   }
else{
               ...
               <div class="col-md-8 offset-md-2">
                  ...
                  <form id="request" class="main_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <input class="contactus" placeholder="email" type="email" name="log_email">                          
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="password" type="password" name="log_password">                          
                        </div>
