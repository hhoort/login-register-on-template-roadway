...
$email_check = "select * from `user-data` where email='$user_email'";
...
if(mysqli_num_rows($email_query)>0){
   ...
   $query("INSERT INTO `user-data` ( `NAME`, `EMAIL`, `PASSWORD`) VALUES ('$user_name', '$user_email', '$user_password')");
   $insert= mysqli_query($connection,$query_check);
   header('location:http://localhost:82/techtemp/techtemp/login.php');
            ...
            <div class="row ">
               <div class="col-md-8 offset-md-2">
                  ...
                  <form id="request" class="main_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                     <div class="row">
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Name" type="type" name="username"> 
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                           <button name="register" class="send_btn">Register</button>
                        </div>
                     </div>
                  </form>
               </div>
